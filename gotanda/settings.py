"""
Django settings for gotanda project.
...
SECRET_KEY = 'e4q(2+wt2lkbwnu(l)izjmg-cq)t)$!7ytk8%%mhe74t3-*u+5'
...
INSTALLED_APPS = [
    ...
    'omikuji.apps.OmikujiConfig',
    'liquormap.apps.LiquormapConfig',
...
WSGI_APPLICATION = 'gotanda.wsgi.application'
